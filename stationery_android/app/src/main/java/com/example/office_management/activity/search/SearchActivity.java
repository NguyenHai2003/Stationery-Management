            ...
            public void onResponse(Call<ApiResponse<UserResponse>> call, Response<ApiResponse<UserResponse>> response) {
                ...
                if (response.isSuccessful() && response.body() != null && response.body().getResult() != null) {
                    ...
                    List<String> recentKeywords = user.getSearchHistory().stream()
                            .sorted((a, b) -> {
                                try {
                                    ...
                                    return dateB.compareTo(dateA); // Mới trước
                                } catch (Exception e) {
                                    return 0;
                                }
                            })
                            .map(SearchHistoryResponse::getKeyword)
                            .distinct() // Tránh trùng từ khoá
                            .limit(6)
                    ...
                    RecentSearchAdapter adapter = new RecentSearchAdapter(recentKeywords, keyword -> {
                        Toast.makeText(SearchActivity.this, "Recent search: " + keyword, Toast.LENGTH_SHORT).show();
                    });
            ...
            public void onResponse(Call<ApiResponse<List<String>>> call, Response<ApiResponse<List<String>>> response) {
                ...
                if (response.isSuccessful() && response.body() != null && response.body().getResult() != null) {
                    ...
                    PopularSearchAdapter adapter = new PopularSearchAdapter(popularKeywords, keyword -> {
                        Toast.makeText(SearchActivity.this, "Popular search: " + keyword, Toast.LENGTH_SHORT).show();
                    });
